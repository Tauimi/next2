    ...
    try {
      const response = await fetch('/api/products', {
        ...
        body: JSON.stringify({
          ...
          categoryId: formData.categoryId,  // Оставляем как строку (CUID)
          brandId: formData.brandId || undefined,  // Опционально, оставляем как строку
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={handleInputChange}
                  placeholder="Оставьте пустым или создайте бренд в админ-панели"
                  className="w-full"
                />
                <p className="text-xs text-muted-foreground mt-1">
                  Пока бренды не реализованы, оставьте поле пустым
                </p>
              </div>
            </div>
          </div>
